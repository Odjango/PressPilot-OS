 ...
 *
 * @package presspilot-fortress-heavy-v1
 */

if (!function_exists('presspilot_fortress_heavy_v1_setup')) {
    /**
     * Theme setup.
     */
    function presspilot_fortress_heavy_v1_setup()
    {
...
add_action('after_setup_theme', 'presspilot_fortress_heavy_v1_setup');

/**
 * Enqueue front-end styles if needed.
 * Keep empty or minimal to encourage theme.json-driven styling.
 */
function presspilot_fortress_heavy_v1_enqueue_styles()
{
    // Intentionally minimal: rely on theme.json for most styling.
    wp_enqueue_style(
        'presspilot-fortress-heavy-v1-style',
        get_stylesheet_uri(),
        array(),
        wp_get_theme()->get('Version')
    );
}
add_action('wp_enqueue_scripts', 'presspilot_fortress_heavy_v1_enqueue_styles');

/**
 * AI Theme Seeder: Automates clean install and content injection.
 */
class presspilot_fortress_heavy_v1_Seeder {
    ...
    public function activation_logic() {
        ...
        if ( get_option( 'presspilot_fortress_heavy_v1_seeded' ) ) {
            return;
        }
        ...
        // 6. Set Flag
        update_option( 'presspilot_fortress_heavy_v1_seeded', true );
    }
    ...
    private function create_pages() {
        ...
        $pages_config = array(
            ...
            'contact' => array(
                'title' => 'Contact',
                'content' => '<!-- wp:paragraph --><p><!-- wp:heading --><h2>Get in Touch</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Email: hello@fortress.pro</p><!-- /wp:paragraph --><!-- wp:group {"style":{"border":{"width":"1px"}}} --><div class="wp-block-group" style="border-width:1px"><!-- wp:paragraph --><p>Name:</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Email:</p><!-- /wp:paragraph --><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link">Send</a></div><!-- /wp:button --></div><!-- /wp:group --></p><!-- /wp:paragraph -->'
            ),
        );
    ...
    private function update_site_options( $pages ) {
        ...
        update_option( 'blogname', 'Fortress Pro' );
...
new presspilot_fortress_heavy_v1_Seeder();
