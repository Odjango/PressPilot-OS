...
<div class="wp-block-group alignfull presspilot-section presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <div class="wp-block-buttons pp-hero-ctas hero-ctas" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-button pp-button-primary btn primary has-contrast-color has-text-color has-link-color"><a class="wp-block-button__link wp-element-button pp-hero-cta-primary btn primary" href="{{HERO_PRIMARY_CTA_URL}}">{{HERO_PRIMARY_CTA}}</a></div>
    <!-- /wp:button -->

    <!-- wp:button {"className":"pp-button-secondary is-style-outline btn secondary","style":{"border":{"width":"1px"}}} -->
    <div class="wp-block-button pp-button-secondary is-style-outline btn secondary has-custom-border wp-element-button" style="border-width:1px"><a class="wp-block-button__link wp-element-button pp-hero-cta-secondary btn secondary" href="{{HERO_SECONDARY_CTA_URL}}">{{HERO_SECONDARY_CTA}}</a></div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
</div>
