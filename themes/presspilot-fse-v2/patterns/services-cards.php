<?php
/**
 * Title: PressPilot – Services Cards
 * Slug: presspilot/services-cards
 * Categories: presspilot, presspilot-starter
 * Description: Three service cards suited for agencies or consultancies.
 */
?>
  ...
  <div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group"
        ...
        <p class="has-sm-font-size">Audience mapping, tone calibration, and input audits that keep kits accurate.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group"
        ...
        <!-- /wp:heading -->
        <!-- wp:paragraph {"fontSize":"sm"} -->
        <p class="has-sm-font-size">Palette, typography, and spacing tokens aligned to Golden Foundation defaults.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group"
        ...
        <!-- /wp:heading -->
        <!-- wp:paragraph {"fontSize":"sm"} -->
        <p class="has-sm-font-size">Hand-off documentation, exports, and on-call support for teams shipping daily.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
