...
/**
 * Title: Hero - Default
 * Slug: presspilot-roma-pizza-v1-2/hero-default
 * Categories: presspilot-roma-pizza-v1-2, text
...
<div class="wp-block-group" style="padding-top:2rem;padding-bottom:2rem;gap:1rem">
    ...
    <div class="wp-block-buttons">
        ...
        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link">View services</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
