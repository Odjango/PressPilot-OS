 ...
 */
add_action( 'after_switch_theme', 'presspilot_roma_pizza_v1_2_activate' );
function presspilot_roma_pizza_v1_2_activate() {
    $destructive = true;
    ...
    // Create Pages
    $pages_config = [
        'home' => ['title' => 'Home', 'content' => 'Welcome to our V1.2 site.'],
