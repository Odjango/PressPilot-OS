...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:15px;padding-right:30px;padding-bottom:15px;padding-left:30px">
	...
	<div class="wp-block-group">
		...
		<p class="has-text-align-center has-x-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'With its minimal design and powerful feature set, This theme enables you to build stylish websites.', 'frost' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:buttons -->
