...
export const getUniversalReservationContent = (content?: PageContent) => {
    return `
    ...
    <div class="wp-block-group alignfull has-base-color has-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
        ...
        <h1 class="wp-block-heading has-text-align-center">Book a Table</h1>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center","fontSize":"large"} -->
        <p class="has-text-align-center has-large-font-size">Join us for an unforgettable evening.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group">
            ...
            <p class="has-text-align-center">Call us directly: <strong>(555) 123-4567</strong></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
