...
import { getUniversalHeaderContent } from './universal-header';
import { getUniversalFooterContent } from './universal-footer';

export { getUniversalHeaderContent, getUniversalFooterContent };
