...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">{{TESTIMONIAL_1_TEXT}}</p>
<!-- /wp:paragraph -->
...
<p class="has-primary-color has-text-color">{{TESTIMONIAL_2_TEXT}}</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-5.webp" alt="{{IMAGE_TESTIMONIAL_1}}" class="wp-image-60" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
