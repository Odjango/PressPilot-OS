...
<div class="wp-block-group alignfull has-base-color has-main-background-color has-text-color has-background has-link-color"
    ...
    <div class="wp-block-columns alignwide"><!-- wp:column -->
        <div class="wp-block-column">
            ...
            <p class="has-main-accent-color has-text-color has-small-font-size">{{FOOTER_TEXT}}</p>
            <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group has-main-accent-color has-text-color has-link-color">
            ...
            <p class="has-small-font-size">© 2025 · Powered by <a href="https://presspilot.com">{{BUSINESS_NAME}}</a></p>
            <!-- /wp:paragraph -->
