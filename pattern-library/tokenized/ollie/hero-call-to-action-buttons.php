...
<h2 class="wp-block-heading has-text-align-center has-secondary-font-family has-x-large-font-size">{{HERO_PRETITLE}}</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
