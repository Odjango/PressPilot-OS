...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">{{FEATURES_TEXT}}</p>
<!-- /wp:paragraph -->
...
<p class="has-x-small-font-size">{{FEATURE_2_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">{{FEATURE_3_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-cover is-light is-style-rounded-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-33151" alt="{{IMAGE_FEATURE_1}}" src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/computer-hands.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
