...
<p class="has-base-color has-text-color has-large-font-size" style="line-height:1.3">{{TESTIMONIAL_1_TEXT}}</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-3.webp" alt="{{IMAGE_TESTIMONIAL_1}}" class="wp-image-58" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<p class="has-main-accent-color has-text-color has-small-font-size">{{TESTIMONIAL_2_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
