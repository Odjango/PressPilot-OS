...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">{{ABOUT_TEXT}}</p>
<!-- /wp:paragraph -->
...
<p style="font-style:normal;font-weight:600">{{ABOUT_MISSION}}</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">{{ABOUT_TAGLINE}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
