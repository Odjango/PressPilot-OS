...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">{{FEATURES_TEXT}}</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:600">{{FEATURE_2_TEXT}}</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">{{FEATURE_3_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
