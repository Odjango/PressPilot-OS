...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">{{CONTACT_TEXT}}</p>
<!-- /wp:paragraph -->
...
<p class="has-main-accent-color has-text-color">{{CONTACT_ADDRESS}}</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"base"} -->
<p class="has-base-color has-text-color">{{CONTACT_STATE}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
