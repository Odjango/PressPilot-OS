		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-columns alignwide has-foreground-color has-text-color">
				...
				<div class="wp-block-column" style="flex-basis:560px">
					...
					<p class="has-large-font-size">{{FEATURES_TEXT}}</p>
					<!-- /wp:paragraph -->
				...
				<div class="wp-block-column is-vertically-aligned-center">
					...
					<div class="wp-block-image is-style-default">
						<figure class="aligncenter size-large is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/illustrations/logo.png" alt="{{IMAGE_FEATURE_1}}" width="256" height="308" /></figure>
					</div>
					<!-- /wp:image -->
				</div>
				<!-- /wp:column -->
