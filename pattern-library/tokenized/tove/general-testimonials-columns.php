	...
	<div class="wp-block-column has-senary-background-color has-background">
		...
		<div class="wp-block-group has-senary-background-color has-background">
			...
			<div class="wp-block-image is-style-rounded">
				<figure class="aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/illustrations/avatar-3.png" alt="{{IMAGE_TESTIMONIAL_1}}" width="100" /></figure>
			</div>
			<!-- /wp:image -->
