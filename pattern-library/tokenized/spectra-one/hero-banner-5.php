...
<h1 class="wp-block-heading has-background-color has-text-color" style="letter-spacing:-1px">{{HERO_TITLE}}</h1>
<!-- /wp:heading -->
...
<figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url( $images[0] ); ?>" alt="{{IMAGE_HERO}}" class="wp-image-1157"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->