...
<p class="has-primary-color has-text-color has-x-small-font-size" style="letter-spacing:2px;text-transform:uppercase">{{FAQ_1_ANSWER}}</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">{{FAQ_TITLE}}</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
