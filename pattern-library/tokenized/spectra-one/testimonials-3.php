...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( $images[0]); ?>" alt="{{IMAGE_TESTIMONIAL_1}}" class="wp-image-938" style="border-radius:20px"/></figure>
<!-- /wp:image -->
