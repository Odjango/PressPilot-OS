...
<figure class="wp-block-image aligncenter size-large swt-duotone-primary"><img src="<?php echo esc_url( $images[0] ); ?>" alt="{{IMAGE_FEATURE_1}}" class="wp-image-139"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image aligncenter size-large swt-duotone-primary"><img src="<?php echo esc_url( $images[1] ); ?>" alt="{{IMAGE_FEATURE_2}}" class="wp-image-866"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">{{FEATURE_2_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->