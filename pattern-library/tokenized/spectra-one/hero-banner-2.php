...
<h1 class="wp-block-heading has-text-align-center has-heading-color has-text-color" style="margin-top:var(--wp--preset--spacing--large);letter-spacing:-1px">{{HERO_TITLE}}</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"heading"} -->
<p class="has-text-align-center has-heading-color has-text-color">{{HERO_TEXT}}</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-primary-color has-text-color wp-element-button">{{HERO_CTA_SECONDARY}}</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
