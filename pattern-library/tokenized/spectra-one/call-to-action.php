...
<h3 class="wp-block-heading has-text-align-left has-white-color has-text-color" style="letter-spacing:-1px">Build your own website</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-small"}}},"textColor":"white"} -->
<p class="has-text-align-left has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--xx-small)">{{CTA_TEXT}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-black-color has-white-background-color has-text-color has-background wp-element-button">{{CTA_BUTTON}}</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
