...
<p style="padding-right:33%">{{CONTACT_ADDRESS}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h5 class="wp-block-heading has-white-color has-text-color">Wade Warren</h5>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"white","fontSize":"x-small"} -->
<p class="has-white-color has-text-color has-x-small-font-size">{{CONTACT_STATE}}</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:heading {"level":5,"textColor":"white","className":"wp-block-heading"} -->
<h5 class="wp-block-heading has-white-color has-text-color">Leslie Alexander</h5>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"white","fontSize":"x-small"} -->
...
<div class="wp-block-group"><!-- wp:heading {"level":5,"textColor":"white","className":"wp-block-heading"} -->
<h5 class="wp-block-heading has-white-color has-text-color">Esther Howard</h5>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"white","fontSize":"x-small"} -->
