	...
	<div class="wp-block-columns alignwide" style="margin-top:0;margin-bottom:0">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image is-style-rounded">
				<img alt="{{IMAGE_GALLERY_1}}" style="aspect-ratio:4/3;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
			...
			<figure class="wp-block-image is-style-rounded">
				<img alt="{{IMAGE_GALLERY_2}}" style="aspect-ratio:3/4;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:image {"aspectRatio":"3/4","scale":"cover","className":"is-style-rounded"} -->
			<figure class="wp-block-image is-style-rounded"><img alt="{{IMAGE_GALLERY_3}}" style="aspect-ratio:3/4;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
