...
<div class="wp-block-group alignwide">
	...
	<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_1920x1200.jpg'; ?>" alt="{{IMAGE_HERO}}" /></figure>
	<!-- /wp:image -->
	...
	<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" id="image-heading-text-buttons" style="margin-top:var(--wp--preset--spacing--medium)">{{HERO_PRETITLE}}</h2>
	<!-- /wp:heading -->
