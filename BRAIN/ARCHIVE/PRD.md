> **ARCHIVED** - This document is superseded. See [BRAIN/VISION/project-vision.md](../VISION/project-vision.md) for the current business vision and [BRAIN/VISION/product-principles.md](../VISION/product-principles.md) for product quality rules.
>
> _Archived: 2026-02-02 | Reason: Original PRD, now replaced by structured VISION documents_

---

# GOLDEN RULES FOR AI AGENTS
1.  **DO NOT SIMULATE:** Do not pretend to work. Write actual code.
2.  **NO TECH DEBT:** If you change a component, do not break its existing styling.
3.  **ASK BEFORE DESTRUCTIVE ACTIONS:** If you plan to delete a folder or rewrite a core config (like `next.config.js`), ask for permission first.
4.  **FILE IS TRUTH:** If the code in `app/page.tsx` conflicts with your training data, trust the code in `app/page.tsx`.
