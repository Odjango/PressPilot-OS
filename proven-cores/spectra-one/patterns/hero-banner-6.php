...
<p class="has-text-align-center has-white-color has-text-color has-x-small-font-size" style="letter-spacing:2px;text-transform:uppercase">Full Site Editing</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--x-small);letter-spacing:-1px">Launch Your Website Today!</h1>
<!-- /wp:heading -->
