	...
	<div class="wp-block-columns are-vertically-aligned-center is-style-columns-reverse">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-x-large-font-size" id="text-on-left-image-on-right">Welcome to Your Site</h2>
				<!-- /wp:heading -->
				<!-- wp:paragraph -->
				<p>With its clean, minimal design and powerful feature set, This theme enables you to build stylish and sophisticated WordPress websites.</p>
				<!-- /wp:paragraph -->
				<!-- wp:buttons -->
