...
<div class="wp-block-group alignwide">
	...
	<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" id="image-heading-text-buttons" style="margin-top:var(--wp--preset--spacing--medium)">Welcome to Frost</h2>
	<!-- /wp:heading -->
