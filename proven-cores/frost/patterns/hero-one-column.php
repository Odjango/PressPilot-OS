...
<div class="wp-block-group alignwide">
	...
	<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" id="image-heading-text-buttons" style="margin-top:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'Welcome to Your Site', 'frost' ); ?></h2>
	<!-- /wp:heading -->
