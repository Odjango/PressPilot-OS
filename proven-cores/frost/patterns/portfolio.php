...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center is-style-columns-reverse">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'This theme is a powerful WordPress theme created for agencies and professional website builders. With its clean, minimal design, Frost provides the perfect canvas for sophisticated websites.', 'frost' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:buttons -->
