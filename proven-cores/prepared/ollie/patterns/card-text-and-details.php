...
<h2 class="wp-block-heading has-base-color has-text-color">Download this theme for free today and start building</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color">This theme ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button">Download this theme</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-base-color has-text-color has-link-color has-x-small-font-size" style="font-style:normal;font-weight:500">— Mandi Alpine, Brandwich</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
