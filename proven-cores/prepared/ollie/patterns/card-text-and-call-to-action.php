...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">Download this theme</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size" style="text-decoration:underline">or view on<a href="#">WordPress.org</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
