...
<p class="has-text-align-center has-primary-accent-color has-text-color"><?php esc_html_e( 'Build your blazing fast website with the power of the WordPress Site Editor and beautiful, pre-made pattern designs from WordPress. No coding skills required.', 'ollie' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
