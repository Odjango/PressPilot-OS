...
<p class="has-base-color has-text-color has-large-font-size" style="line-height:1.3"><?php esc_html_e( 'Wow, I really can\'t believe how powerful the WordPress Site Editor is combined with WordPress. I don\'t even need a page builder anymore!', 'ollie' ); ?></p>
<!-- /wp:paragraph -->
