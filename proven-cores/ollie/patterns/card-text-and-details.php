...
<h2 class="wp-block-heading has-base-color has-text-color"><?php esc_html_e( 'Download this theme for free today and start building', 'ollie' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color"><?php esc_html_e( 'This theme ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes.', 'ollie' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Download this theme', 'ollie' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
