...
<div class="wp-block-group alignfull has-base-color has-main-background-color has-text-color has-background has-link-color"
    ...
    <div class="wp-block-columns alignwide"><!-- wp:column -->
        <div class="wp-block-column">
            ...
            <!-- wp:social-links {"iconColor":"main","iconBackgroundColor":"base","className":"is-style-default","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|small","left":"var:preset|spacing|small"}}},"layout":{"type":"flex","justifyContent":"left"}} -->
    ...
    <hr
        class="wp-block-separator alignwide has-text-color has-border-dark-color has-alpha-channel-opacity has-border-dark-background-color has-background is-style-separator-thin" />
    <!-- /wp:separator -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group has-main-accent-color has-text-color has-link-color">
            ...
            <p class="has-small-font-size">© 2025 · Powered by <a href="https://presspilot.com">PressPilot OS</a></p>
            <!-- /wp:paragraph -->
