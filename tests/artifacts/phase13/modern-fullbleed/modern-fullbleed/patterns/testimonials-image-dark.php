...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<p style="margin-top:0">With its clean, minimal design and powerful features, This theme enables you to build cool websites.</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image size-full is-resized has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_white_800x800.jpg'; ?>" alt="Testimonial Avatar" style="border-radius:50px" width="60" height="60"/></figure>
				<!-- /wp:image -->
