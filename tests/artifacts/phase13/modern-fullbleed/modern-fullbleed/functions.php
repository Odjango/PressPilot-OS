 ...
 */
    ...
    if (!function_exists('pp_setup_1770041337726')) {
        function pp_setup_1770041337726() {
            // 1. Set Site Identity
            update_option('blogname', 'Ember & Oak' );
            update_option('blogdescription', 'Contemporary American dining featuring locally-sourced ingredients and innovative farm-to-table cuisine in an elegant urban setting.' );
        ...
        $setup_func = 'pp_setup_1770041337726';
