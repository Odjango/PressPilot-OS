 ...
 * Slug: tove/restaurant-location
 * Categories: tove-restaurant
 */
?>
<!-- wp:media-text {"mediaPosition":"right","mediaLink":"https://picsum.photos/seed/1000/1200/800","mediaType":"image","mediaSizeSlug":"full","imageFill":true,"focalPoint":{"x":0,"y":"0.50"},"backgroundColor":"senary","className":"is-style-default"} -->
	...
	<div class="wp-block-media-text__content">
		...
		<div class="wp-block-columns is-style-tove-horizontal-separators">
			...
			<div class="wp-block-column">
				...
				<!-- wp:paragraph -->
				<p>456 Little Italy Way<br>Chicago</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p>hello@mammarosa.com<br>(312) 555-7890</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
