...
<div class="wp-block-columns alignwide"><!-- wp:column {"backgroundColor":"senary"} -->
	<div class="wp-block-column has-senary-background-color has-background">
		...
		<div class="wp-block-group has-senary-background-color has-background">
			...
			<div class="wp-block-image is-style-rounded">
				<figure class="aligncenter size-full is-resized"><img src="https://picsum.photos/seed/1000/1200/800" alt="" width="100" /></figure>
			</div>
			<!-- /wp:image -->
			...
			<blockquote class="wp-block-quote has-text-align-center is-style-default"><!-- wp:paragraph -->
				<p>“Mamma Rosa Pizzeria serves the best service in Chicago. It’s not even close.”</p>
	...
	<div class="wp-block-column has-senary-background-color has-background">
		...
		<div class="wp-block-group has-senary-background-color has-background">
			<!-- wp:image {"align":"center","width":100,"sizeSlug":"full","linkDestination":"none","className":"is-style-rounded"} -->
			<div class="wp-block-image is-style-rounded">
				<figure class="aligncenter size-full is-resized"><img src="https://picsum.photos/seed/1001/1200/800" alt="" width="100" /></figure>
			</div>
			<!-- /wp:image -->
	...
	<div class="wp-block-column has-senary-background-color has-background">
		...
		<div class="wp-block-group has-senary-background-color has-background">
			<!-- wp:image {"align":"center","width":100,"sizeSlug":"full","linkDestination":"none","className":"is-style-rounded"} -->
			<div class="wp-block-image is-style-rounded">
				<figure class="aligncenter size-full is-resized"><img src="https://picsum.photos/seed/1002/1200/800" alt="" width="100" /></figure>
			</div>
			<!-- /wp:image -->
