		...
		<div class="wp-block-columns is-not-stacked-on-mobile">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:157px">
				...
				<div class="wp-block-buttons is-content-justification-right">
					...
					<div class="wp-block-button has-custom-font-size is-style-fill has-small-font-size"><a class="wp-block-button__link has-primary-background-color has-background" style="padding-top:14px;padding-right:21px;padding-bottom:14px;padding-left:21px">(555) 444-5555</a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
