...
<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-image-fill is-style-default has-senary-background-color has-background">
	...
	<div class="wp-block-media-text__content">
		...
		<h6 class="has-secondary-background-color has-background" style="margin-top:0;margin-bottom:0">789 Harbor Drive</h6>
		<!-- /wp:heading -->
		...
		<p class="has-large-font-size">See our recommendations for the best experiences at Ember & Oak Steakhouse in Downtown.</p>
		<!-- /wp:paragraph -->
