 ...
 * Slug: 019cc10d-2e38-714f-890a-063655449b26/text-and-image-columns-with-icons
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">We bring passion, precision, and professionalism to every project.</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Why Work With Us</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Years of experience delivering outstanding results across diverse creative disciplines.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-x-small-font-size">We work closely with you to understand your vision and bring it to reality.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">Every detail matters. We maintain the highest standards in all our work.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
