<?php
/**
 * Title: ollie pricing-table-3-column
 * Slug: 019cc10d-2e38-714f-890a-063655449b26/pricing-table-3-column
 * Categories: presspilot/pricing
 */
?>
...
<p class="has-primary-font-family has-x-large-font-size" style="font-style:normal;font-weight:500;line-height:1"></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
