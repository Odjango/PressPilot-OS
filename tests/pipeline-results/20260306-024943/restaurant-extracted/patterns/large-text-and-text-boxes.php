<?php
/**
 * Title: ollie large-text-and-text-boxes
 * Slug: 019cc10d-124c-72e9-85a6-6e609ec25e56/large-text-and-text-boxes
 * Categories: presspilot/about
 */
?>
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Bella Trattoria has been serving authentic Italian cuisine for over 25 years. Founded by Chef Marco Benedetti, our restaurant combines traditional recipes with contemporary dining experiences. Every dish is crafted with passion and the highest quality ingredients sourced directly from Italy.</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme.<mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-color">No coding skills required.</mark></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">To bring the warmth and flavors of Italy to every guest who walks through our doors.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Where tradition meets hospitality</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
