<?php
/**
 * Title: ollie footer-light
 * Slug: 019cc10d-124c-72e9-85a6-6e609ec25e56/footer-light
 * Categories: presspilot/footer
 */
?>
...
<div class="wp-block-group alignfull has-main-color has-base-background-color has-text-color has-background has-link-color"
    ...
    <div class="wp-block-columns alignwide"><!-- wp:column -->
        <div class="wp-block-column">
            ...
            <p class="has-small-font-size">Bella Trattoria brings authentic Italian cuisine and warm hospitality to our community.</p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column"><!-- wp:columns -->
            <div class="wp-block-columns"><!-- wp:column {"metadata":{"name":"Nav Column"}} -->
                <div class="wp-block-column">
                    ...
                    <p style="font-style:normal;font-weight:600">© 2026 Bella Trattoria. All rights reserved.</p>
                    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group alignwide has-secondary-color has-text-color has-link-color" style="padding-top:40px">
        ...
        <div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
            <p class="has-small-font-size">© 2025 <strong>·</strong>&nbsp;Powered by <a
                    href="https://presspilot.com">Bella Trattoria</a></p>
            <!-- /wp:paragraph -->
