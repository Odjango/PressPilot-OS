<?php
/**
 * Title: ollie feature-boxes-with-button
 * Slug: 019cc10d-124c-72e9-85a6-6e609ec25e56/feature-boxes-with-button
 * Categories: presspilot/features
 */
?>
...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Discover what makes our restaurant special</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center">Why Choose Bella Trattoria</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Traditional Italian recipes passed down through generations, prepared by our experienced culinary team.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">Imported directly from Italy, ensuring genuine flavor and quality in every dish.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">A warm and sophisticated setting perfect for special occasions and memorable dining experiences.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
