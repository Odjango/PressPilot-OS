<?php
/**
 * Title: ollie card-contact
 * Slug: 019cc10d-19d9-71f9-8ac2-87b0178ab559/card-contact
...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">Ready to transform your business? Contact us today to discuss your project.</p>
<!-- /wp:paragraph -->
...
<p class="has-main-accent-color has-text-color">456 Innovation Drive</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"base"} -->
<p class="has-base-color has-text-color">CA</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
