 ...
 * Slug: 019cc10d-19d9-71f9-8ac2-87b0178ab559/hero-dark
...
<p class="has-text-align-center has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Empowering businesses with cutting-edge digital services and innovative technology solutions.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":1,"className":"has-secondary-font-family","style":{"typography":{"fontSize":"4rem"}}} -->
<h1 class="wp-block-heading has-text-align-center has-secondary-font-family" style="font-size:4rem">Your Digital Solutions Partner</h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-brand"><a class="wp-block-button__link wp-element-button">Explore Services</a></div>
<!-- /wp:button -->
