<?php
/**
 * Title: ollie text-and-image-columns-with-icons
 * Slug: 019cc10d-19d9-71f9-8ac2-87b0178ab559/text-and-image-columns-with-icons
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">We bring expertise, innovation, and dedication to every project.</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Why Partner With Us</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Skilled professionals with years of industry experience and proven track records.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-x-small-font-size">Cutting-edge technology and creative strategies tailored to your business needs.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">Ongoing partnership and support to ensure your continued success and growth.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
