 ...
 * Slug: 019cc10d-2763-703d-b817-000488843a6e/feature-boxes-with-button
...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Industry-leading tools for cloud monitoring and optimization.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center">Why Choose CloudMetrics</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Track your cloud resources with instant updates and live dashboards.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">Deep insights into performance trends and cost optimization opportunities.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Expert support team ready to help you maximize your cloud investment.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
