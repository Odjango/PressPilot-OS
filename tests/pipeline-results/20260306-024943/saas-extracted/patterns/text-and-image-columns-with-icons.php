 ...
 * Slug: 019cc10d-2763-703d-b817-000488843a6e/text-and-image-columns-with-icons
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Industry-leading tools for cloud monitoring and optimization.</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Why Choose CloudMetrics</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Track your cloud resources with instant updates and live dashboards.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-x-small-font-size">Deep insights into performance trends and cost optimization opportunities.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">Expert support team ready to help you maximize your cloud investment.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
