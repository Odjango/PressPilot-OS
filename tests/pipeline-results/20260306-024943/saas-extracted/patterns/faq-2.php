<?php
/**
 * Title: spectra-one faq-2
 * Slug: 019cc10d-2763-703d-b817-000488843a6e/faq-2
 * Categories: presspilot/faq
 */
?>
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:group {"layout":{"type":"constrained"}} -->
...
<p class="has-primary-color has-text-color has-x-small-font-size" style="letter-spacing:2px;text-transform:uppercase"></p>
<!-- /wp:paragraph -->
