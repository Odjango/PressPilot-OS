<?php
/**
 * Title: ollie hero-dark
 * Slug: 019cc10d-2763-703d-b817-000488843a6e/hero-dark
 * Categories: presspilot/hero
 */
?>
...
<p class="has-text-align-center has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Gain complete visibility into your cloud performance with comprehensive metrics and actionable insights.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":1,"className":"has-secondary-font-family","style":{"typography":{"fontSize":"4rem"}}} -->
<h1 class="wp-block-heading has-text-align-center has-secondary-font-family" style="font-size:4rem">Monitor Your Cloud Infrastructure in Real-Time</h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-brand"><a class="wp-block-button__link wp-element-button">Start Free Trial</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-button-light"} -->
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button">View Demo</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
