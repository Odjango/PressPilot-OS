 ...
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/feature-boxes-with-button
...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Experienced professionals dedicated to your satisfaction.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center">Why Choose Summit</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Available anytime for urgent plumbing and heating issues.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">Fully certified professionals with comprehensive insurance coverage.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">No hidden fees. Transparent quotes before any work begins.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
