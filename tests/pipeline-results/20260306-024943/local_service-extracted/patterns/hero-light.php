<?php
/**
 * Title: ollie hero-light
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/hero-light
...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Expert solutions for residential and commercial plumbing and heating needs. Fast, reliable service you can count on.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Get Free Quote</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-secondary-button"} -->
<div class="wp-block-button is-style-secondary-button"><a class="wp-block-button__link wp-element-button">View Services</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
