 ...
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/text-and-image-columns-with-icons
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Experienced professionals dedicated to your satisfaction.</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Why Choose Summit</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Available anytime for urgent plumbing and heating issues.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-x-small-font-size">Fully certified professionals with comprehensive insurance coverage.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size">No hidden fees. Transparent quotes before any work begins.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
