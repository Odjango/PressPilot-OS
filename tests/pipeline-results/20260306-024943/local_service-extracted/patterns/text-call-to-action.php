<?php
/**
 * Title: ollie text-call-to-action
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/text-call-to-action
...
<h2 class="wp-block-heading has-text-align-center">Ready for reliable service?</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Call us today for fast, professional plumbing and heating solutions.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-button-light"} -->
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button">Schedule Service</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
