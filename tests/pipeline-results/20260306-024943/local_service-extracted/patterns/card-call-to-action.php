<?php
/**
 * Title: ollie card-call-to-action
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/card-call-to-action
 * Categories: presspilot/cta
 */
?>
...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">Call us today for fast, professional plumbing and heating solutions.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-light"><a class="wp-block-button__link wp-element-button" href="https://olliewp.com">Schedule Service</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size">or view on<a href="#">WordPress.org</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
