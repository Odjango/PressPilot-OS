<?php
/**
 * Title: spectra-one contact-2
 * Slug: 019cc10d-20b4-731f-aa61-85c24eebc92c/contact-2
 * Categories: presspilot/contact
 */
?>
...
<p class="has-text-align-center has-white-color has-text-color has-x-small-font-size">Contact us today for a free quote or to schedule an appointment.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" style="border-radius:99px">info@summitplumbing.com</a></div>
<!-- /wp:button -->
