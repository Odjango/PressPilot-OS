...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column">
      ...
      <h2 class="wp-block-heading has-xl-font-size pp-contact-heading">Ready to work with New Beedo?</h2>
      <!-- /wp:heading -->
      <!-- wp:paragraph {"fontSize":"sm"} -->
      <p class="has-sm-font-size pp-contact-body">Share a bit about your services and the neighborhoods you cover. We’ll tailor the kit around it. Reach us at hello@new-beedo.com.</p>
      <!-- /wp:paragraph -->
      <!-- wp:list {"fontSize":"sm"} -->
      <ul class="has-sm-font-size pp-contact-body"><li><strong>Email:</strong> <span class="pp-contact-email">hello@new-beedo.com</span></li></ul>
      <!-- /wp:list -->
    </div>
    <!-- /wp:column -->
