...
<div class="wp-block-group presspilot-section presspilot-pattern cta-contact has-soft-bg-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-columns cta-contact-grid">
    ...
    <div class="wp-block-column cta-contact__copy">
      ...
      <h2 class="wp-block-heading has-xl-font-size pp-contact-heading">Ready to work with Aldo's Pizza?</h2>
      <!-- /wp:heading -->

      <!-- wp:paragraph {"fontSize":"sm"} -->
      <p class="has-sm-font-size pp-contact-body">Share a bit about your services and the neighborhoods you cover. We’ll tailor the kit around it. Reach us at hello@aldo-s-pizza.com.</p>
      <!-- /wp:paragraph -->

      <!-- wp:list {"fontSize":"sm"} -->
      <ul class="has-sm-font-size"><li><strong>Email:</strong> <span class="pp-contact-email">hello@aldo-s-pizza.com</span></li></ul>
      <!-- /wp:list -->
    </div>
    <!-- /wp:column -->
