...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column">
      ...
      <h2 class="wp-block-heading has-xl-font-size pp-contact-heading">Ready to talk?</h2>
      <!-- /wp:heading -->
      <!-- wp:paragraph {"fontSize":"sm"} -->
      <p class="has-sm-font-size pp-contact-body">Tell visitors how to reach you and what happens next after they send a message. Mention your typical response time.</p>
      <!-- /wp:paragraph -->
      <!-- wp:list {"fontSize":"sm"} -->
      <ul class="has-sm-font-size pp-contact-body"><li><strong>Email:</strong> hello@presspilot.app</li><li><strong>Phone:</strong> +1 (000) 000-0000</li><li><strong>Address:</strong> 123 Studio Row, Anywhere</li></ul>
      <!-- /wp:list -->
    </div>
    <!-- /wp:column -->
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group" style="border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
        <!-- wp:paragraph {"fontSize":"sm"} -->
        <p class="has-sm-font-size pp-contact-body">Drop in your preferred form block here or embed a Calendly/booking tool.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
