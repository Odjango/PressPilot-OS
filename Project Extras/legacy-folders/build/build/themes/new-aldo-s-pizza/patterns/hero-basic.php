...
<div class="wp-block-group alignfull presspilot-section presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline hero-title">New Aldo's Pizza</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg","className":"hero-subtitle"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline hero-subtitle">New Aldo's Pizza has the best pizza in town</p>
  <!-- /wp:paragraph -->
