...
<h1 class="wp-block-heading has-text-align-center has-heading-color has-text-color" style="margin-top:var(--wp--preset--spacing--large);letter-spacing:-1px">Launch Your Website Today!</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"heading"} -->
<p class="has-text-align-center has-heading-color has-text-color">Create a functional and visually appealing website</p>
<!-- /wp:paragraph -->
