...
<h6 class="wp-block-heading">Download Spectra Theme</h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-small"}}},"textColor":"body","fontSize":"x-small"} -->
<p class="has-body-color has-text-color has-x-small-font-size" style="margin-top:var(--wp--preset--spacing--xx-small)">Version 1.0.0</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="#">Download Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
