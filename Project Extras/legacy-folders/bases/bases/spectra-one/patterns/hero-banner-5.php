...
<h1 class="wp-block-heading has-background-color has-text-color" style="letter-spacing:-1px">Launch Your Website Today!</h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"background"} -->
<p class="has-background-color has-text-color">Create a functional and visually appealing website</p>
<!-- /wp:paragraph -->
