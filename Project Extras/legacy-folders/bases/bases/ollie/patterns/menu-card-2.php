...
<p class="has-medium-font-size"><strong>How we can help</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-dark"><a class="wp-block-button__link has-x-small-font-size has-custom-font-size wp-element-button">Read More</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
