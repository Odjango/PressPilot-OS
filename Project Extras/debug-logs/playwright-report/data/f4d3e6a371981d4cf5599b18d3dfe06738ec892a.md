  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - paragraph [ref=e6]:
        ...
        - textbox "Username or Email Address" [ref=e8]: password123
      - generic [ref=e9]:
    ...
    - paragraph [ref=e19]:
      - link "Lost your password?" [ref=e20] [cursor=pointer]:
        - /url: http://localhost:8089/wp-login.php?action=lostpassword
    - paragraph [ref=e21]:
      - link "← Go to Bella Cafe" [ref=e22] [cursor=pointer]:
