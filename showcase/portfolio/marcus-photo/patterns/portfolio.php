...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center is-style-columns-reverse">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-x-large-font-size" id="sample-heading">Marcus Rivera Photography</h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<figure class="wp-block-gallery has-nested-images columns-0 is-cropped">
				...
				<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_800x800.jpg'; ?>" alt="Sample Image"/></figure>
				<!-- /wp:image -->
				<!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
				<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_800x800.jpg'; ?>" alt="Sample Image"/></figure>
				<!-- /wp:image -->
