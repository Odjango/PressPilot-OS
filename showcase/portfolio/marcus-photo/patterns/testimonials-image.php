...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-border-color has-contrast-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<p style="margin-top:0">Outstanding service and attention to detail. Truly impressed!</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image size-full is-resized has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_800x800.jpg'; ?>" alt="Testimonial Avatar" style="border-radius:50px" width="60" height="60"/></figure>
				<!-- /wp:image -->
				...
				<div class="wp-block-group" style="line-height:1.5">
					...
					<p class="has-small-font-size"><strong>Sarah M.</strong></p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"fontSize":"small"} -->
		...
		<div class="wp-block-column has-border-color has-contrast-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group" style="line-height:1.5">
					<!-- wp:paragraph {"fontSize":"small"} -->
					<p class="has-small-font-size"><strong>Michael T.</strong></p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"fontSize":"small"} -->
		...
		<div class="wp-block-column has-border-color has-contrast-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group" style="line-height:1.5">
					<!-- wp:paragraph {"fontSize":"small"} -->
					<p class="has-small-font-size"><strong>Jennifer L.</strong></p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"fontSize":"small"} -->
