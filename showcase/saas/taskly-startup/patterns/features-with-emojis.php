...
<p class="has-primary-accent-color has-text-color">This theme ships with over twenty beautiful pattern designs you can use to build a stunning and powerful website. Easily drag and drop patterns to create a design and hit publish!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">This theme ships with over ten professionally-designed page templates (About, Profile, Download, etc.) so you can get your site off the ground in no time.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
