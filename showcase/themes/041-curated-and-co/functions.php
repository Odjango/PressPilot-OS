 ...
 */
    ...
    if (!function_exists('pp_setup_1770944530568')) {
        function pp_setup_1770944530568() {
            // 1. Set Site Identity
            update_option('blogname', 'Curated &amp;amp;amp; Co' );
            update_option('blogdescription', 'Designed for the ecommerce space, Curated &amp;amp;amp; Co blends modern aesthetics with practical conversion-focused content.' );
        ...
        $setup_func = ( __NAMESPACE__ ? __NAMESPACE__ . '\\' : '' ) . 'pp_setup_1770944530568';
