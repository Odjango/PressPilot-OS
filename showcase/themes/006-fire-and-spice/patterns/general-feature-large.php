		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-columns alignwide has-foreground-color has-text-color">
				...
				<div class="wp-block-column" style="flex-basis:560px">
					...
					<h1 style="font-weight:500">Say Hi to the New Fire &amp;amp; Spice App</h1>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"fontSize":"large"} -->
					<p class="has-large-font-size">It's Monday morning, you're running late to the office, but you need what you need to wake up before the first meeting, and the line at Fire &amp;amp; Spice is loooong. Sounds familiar?</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"fontSize":"large"} -->
					<p class="has-large-font-size">With the new <strong>Fire &amp;amp; Spice app</strong>, you can place your order and have it ready by a time of your choosing. Pay directly in the app and skip the lines. Download it now!</p>
					<!-- /wp:paragraph -->
