	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-heading-font-family has-x-large-font-size" style="line-height:1.2">{{BUSINESS_NAME}} offers comprehensive consulting, management, design, and research solutions. Every architectural endeavor is an opportunity to shape the future.</p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<figure class="wp-block-image size-large is-style-rounded">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/museum.webp" alt="A ramp along a curved wall in the Kiasma Museu, Helsinki, Finland" style="aspect-ratio:3/4;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
