	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				...
				<h3 class="wp-block-heading is-style-asterisk">{{BUSINESS_NAME}} Architect App</h3>
				<!-- /wp:heading -->
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tourist-and-building.webp" alt="Tourist taking photo of a building" />
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:50%">
				<!-- wp:image {"aspectRatio":"4/3","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/windows.webp" alt="Windows of a building in Nuremberg, Germany" />
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				<!-- wp:heading {"level":3,"className":"is-style-asterisk"} -->
				<h3 class="wp-block-heading is-style-asterisk">{{BUSINESS_NAME}} Newsletter</h3>
				<!-- /wp:heading -->
