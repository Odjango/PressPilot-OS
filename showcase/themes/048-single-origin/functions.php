 ...
 */
    ...
    if (!function_exists('pp_setup_1770944536071')) {
        function pp_setup_1770944536071() {
            // 1. Set Site Identity
            update_option('blogname', 'Single Origin' );
            update_option('blogdescription', 'Designed for the ecommerce space, Single Origin blends minimal aesthetics with practical conversion-focused content.' );
        ...
        $setup_func = ( __NAMESPACE__ ? __NAMESPACE__ . '\\' : '' ) . 'pp_setup_1770944536071';
