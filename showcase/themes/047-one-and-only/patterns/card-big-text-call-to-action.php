...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore Ollie</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Ollie block theme. No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-light"><a class="wp-block-button__link wp-element-button" href="https://olliewp.com">Get Started Today</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->
