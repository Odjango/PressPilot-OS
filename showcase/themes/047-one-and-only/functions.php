 ...
 */
    ...
    if (!function_exists('pp_setup_1770944534886')) {
        function pp_setup_1770944534886() {
            // 1. Set Site Identity
            update_option('blogname', 'One &amp;amp;amp; Only' );
            update_option('blogdescription', 'Designed for the ecommerce space, One &amp;amp;amp; Only blends playful aesthetics with practical conversion-focused content.' );
        ...
        $setup_func = ( __NAMESPACE__ ? __NAMESPACE__ . '\\' : '' ) . 'pp_setup_1770944534886';
