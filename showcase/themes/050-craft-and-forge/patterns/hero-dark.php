...
<p class="has-text-align-center has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">{{HERO_PRETITLE}}</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-button-brand"><a class="wp-block-button__link wp-element-button">Download this theme</a></div>
<!-- /wp:button -->
