...
<div class="wp-block-group alignfull"
	...
	<div class="wp-block-group alignwide has-base-2-background-color has-background"
		style="border-radius:16px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
		<!-- wp:group {"align":"wide","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
		<div class="wp-block-group alignwide">
			<!-- wp:heading {"textAlign":"center"} -->
			<h2 class="wp-block-heading has-text-align-center">{{PRICING_TITLE}}</h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column"
				style="border-top-color:var(--wp--preset--color--contrast-3);border-top-width:1px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--30)">
				...
				<h5 class="wp-block-heading has-text-align-center has-x-large-font-size">{{PLAN_1_PRICE}}</h5>
				<!-- /wp:heading -->
				...
				<div class="wp-block-group">
					...
					<p class="has-text-align-center">{{PLAN_1_FEATURE_1}}</p>
					<!-- /wp:paragraph -->
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-outline">
						<a class="wp-block-button__link wp-element-button">{{PRICING_CTA}}</a>
					</div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			...
			<div class="wp-block-column"
				style="border-top-color:var(--wp--preset--color--contrast);border-top-width:2px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--30)">
				...
				<!-- wp:heading {"textAlign":"center","level":5,"fontSize":"x-large"} -->
				<h5 class="wp-block-heading has-text-align-center has-x-large-font-size">{{PLAN_2_PRICE}}</h5>
				<!-- /wp:heading -->
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_2_FEATURE_1}}</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_2_FEATURE_2}}</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_2_FEATURE_3}}</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-column"
				...
				<!-- wp:heading {"textAlign":"center","level":5,"fontSize":"x-large"} -->
				<h5 class="wp-block-heading has-text-align-center has-x-large-font-size">{{PLAN_3_PRICE}}</h5>
				<!-- /wp:heading -->
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_3_FEATURE_1}}</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_3_FEATURE_2}}</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">{{PLAN_3_FEATURE_3}}</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
