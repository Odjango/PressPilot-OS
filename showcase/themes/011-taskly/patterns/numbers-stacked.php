...
<p class="has-primary-accent-color has-text-color">This theme ships with over 50 pixel-perfect pattern designs you can use to build a stunning website with a few clicks.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">This theme ships with several full page designs such as Homepage, About, Features, Download, and more.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">We've spent thousands of hours crafting WordPress themes and applied everything we know to WordPress.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
