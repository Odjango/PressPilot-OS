 ...
 */
    ...
    if (!function_exists('pp_setup_1770938672928')) {
        function pp_setup_1770938672928() {
            // 1. Set Site Identity
            update_option('blogname', 'Bella Trattoria' );
            update_option('blogdescription', 'House-made pasta, wood-fired specialties, and warm hospitality in the heart of San Francisco.' );
        ...
        $setup_func = 'pp_setup_1770938672928';
