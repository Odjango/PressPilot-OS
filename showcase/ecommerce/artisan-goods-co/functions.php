 ...
 */
    ...
    if (!function_exists('pp_setup_1770938678306')) {
        function pp_setup_1770938678306() {
            // 1. Set Site Identity
            update_option('blogname', 'Artisan Goods Co.' );
            update_option('blogdescription', 'Curated goods from independent makers and local studios.' );
        ...
        $setup_func = ( __NAMESPACE__ ? __NAMESPACE__ . '\\' : '' ) . 'pp_setup_1770938678306';
