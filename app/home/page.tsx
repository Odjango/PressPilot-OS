                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-sm text-slate-400">
                            Four simple steps — engineered to produce editor-safe WordPress themes.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="p-5 bg-slate-900/60 border border-slate-800/60 rounded-lg">
                            <p className="text-cyan-400 font-semibold text-sm mb-2">01 — Enter Business Info</p>
                            <p className="text-sm text-slate-400 leading-relaxed">
                                Provide your business name, description, and goals. This information shapes structured, FSE-safe layouts.
                            </p>
                        </div>

                        <div className="p-5 bg-slate-900/60 border border-slate-800/60 rounded-lg">
                            <p className="text-cyan-400 font-semibold text-sm mb-2">02 — Choose Your Style</p>
                            <p className="text-sm text-slate-400 leading-relaxed">
                                Select colors, fonts, and hero layouts mapped to valid theme.json settings and proven base themes.
                            </p>
                        </div>

                        <div className="p-5 bg-slate-900/60 border border-slate-800/60 rounded-lg">
                            <p className="text-cyan-400 font-semibold text-sm mb-2">03 — Preview & Customize</p>
                            <p className="text-sm text-slate-400 leading-relaxed">
                                See your theme come together using editor-compatible blocks and layouts; adjust details before export.
                            </p>
                        </div>

                        <div className="p-5 bg-slate-900/60 border border-slate-800/60 rounded-lg">
                            <p className="text-cyan-400 font-semibold text-sm mb-2">04 — Download Theme</p>
                            <p className="text-sm text-slate-400 leading-relaxed">
                                Get a production-ready WordPress theme ZIP — validated, installable, and fully editable in the Site Editor.
                            </p>
                        </div>
                    </div>
                </div>
