  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        ...
        {error && (
          <p className="rounded-xl border border-red-200 bg-red-50 px-4 py-2 text-sm text-red-700 shadow-sm">{error}</p>
        )}
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.3fr)]">
          <div className="space-y-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <div className="space-y-4">
              <div className="flex items-baseline justify-between gap-2">
                ...
                <p className="text-xs text-neutral-500">
                  These fields map one-to-one with the Stage 02 schema. This flows directly into the generator.
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-neutral-500">
                Preview touches only the style layer. Generate builds the full WordPress theme + static kits.
              </p>
          ...
          <div className="space-y-5 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
            <div className="space-y-2">
              ...
              <p className="text-xs text-neutral-500">
                Visual hint only. Real layout is rendered in WordPress using the Golden Foundation theme + patterns.
              </p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">{primaryLanguage}</p>
