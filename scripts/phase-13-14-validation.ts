...
const TESTS: TestConfig[] = [
    {
        ...
        payload: {
            ...
            data: {
                ...
                businessDescription: 'A warm neighborhood cafe serving artisan coffee, fresh pastries, and homemade comfort food',
                businessCategory: 'restaurant',
                tagline: 'Welcome to The Cozy Cup Cafe',
                email: 'hello@cozycup.com',
                website: 'https://cozycup.com',
    ...
    },
    {
        ...
        payload: {
            ...
            data: {
                ...
                businessDescription: 'Contemporary wine bar featuring curated selections from local vineyards paired with seasonal small plates',
                businessCategory: 'restaurant',
                tagline: 'Slate Wine Bar',
                email: 'reservations@slatewine.com',
                website: 'https://slatewine.com',
                name: 'Slate Wine Bar',
                industry: 'restaurant',
                brandStyle: 'modern',
    ...
    },
    {
        ...
        payload: {
            ...
            data: {
                businessName: 'Ember & Oak Steakhouse',
                businessDescription: 'Premium steakhouse with dry-aged cuts, craft cocktails, and an upscale dining experience',
                businessCategory: 'restaurant',
                tagline: 'Ember & Oak Steakhouse',
    ...
    },
    {
        ...
        payload: {
            ...
            data: {
                businessName: 'Nori Sushi House',
                businessDescription: 'Minimalist Japanese restaurant specializing in omakase and traditional sushi preparation',
                businessCategory: 'restaurant',
                tagline: 'Nori Sushi House',
                email: 'reserve@norisushi.com',
                website: 'https://norisushi.com',
