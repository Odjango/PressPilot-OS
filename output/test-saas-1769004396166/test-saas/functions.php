...
function presspilot_setup_1769004396270() {
    // 0. FLUSH CACHE (Critical for persistence)
    wp_cache_flush();

    // 1. Set Site Identity
    update_option('blogname', 'Test SaaS' . ' [UPDATED]' );
    update_option('blogdescription', 'Test Sub' );
...
add_action('init', 'presspilot_setup_1769004396270');
