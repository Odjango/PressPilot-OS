...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase;letter-spacing:2px">Main Menu</h2>
  <!-- /wp:heading -->
...
<div class="wp-block-column" style="flex-basis:50%">
  ...
  <div class="wp-block-group">
    ...
    <h4 class="wp-block-heading" style="font-style:normal;font-weight:700">Burger</h4>
    <!-- /wp:heading -->
  ...
  <p class="has-small-font-size" style="font-style:italic">Yum</p>
  <!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
  </div>
