...
<div class="wp-block-group alignfull">
    ...
    <!-- wp:cover {"url":"https://s.w.org/images/core/5.3/MtBlanc1.jpg","dimRatio":60,"overlayColor":"black","align":"full"} -->
    <div class="wp-block-cover alignfull has-black-background-color has-background-dim-60 has-background-dim">
        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-group is-layout-constrained">
                ...
                <p class="has-text-align-center has-base-color has-text-color has-medium-font-size">
                    A high-performance foundation generated instantly by PressPilot. Scalable, secure, and ready for
                    growth.
                </p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-buttons">
                    ...
                    <div class="wp-block-button"><a
                            class="wp-block-button__link has-base-color has-brand-primary-background-color has-text-color has-background wp-element-button">Start
                            Now</a></div>
                    <!-- /wp:button -->

                    <!-- wp:button {"className":"is-style-outline","textColor":"base"} -->
                    <div class="wp-block-button is-style-outline"><a
                            class="wp-block-button__link has-base-color has-text-color wp-element-button">Documentation</a>
                    </div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->
    ...
    <div
        ...
        <div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background">
            ...
            <p class="has-text-align-center has-small-font-size">— A Happy Customer</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
