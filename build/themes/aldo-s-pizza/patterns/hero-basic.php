...
<div class="wp-block-group alignfull presspilot-section presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline hero-title">Aldo's Pizza</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg","className":"hero-subtitle"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline hero-subtitle">Aldo's Pizza has the best pizza in town</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons pp-hero-ctas hero-ctas" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-button pp-button-secondary is-style-outline btn secondary has-custom-border wp-element-button" style="border-width:1px"><a class="wp-block-button__link wp-element-button pp-hero-cta-secondary btn secondary" href="#portfolio">See sample site</a></div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
</div>
