...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column">
      ...
      <h2 class="wp-block-heading has-xl-font-size pp-contact-heading">Ready to work with Tourantine?</h2>
      <!-- /wp:heading -->
      <!-- wp:paragraph {"fontSize":"sm"} -->
      <p class="has-sm-font-size pp-contact-body">Tell us about your client roster or the next campaign. We’ll prep a polished starter kit. Reach us at hello@tourantine.com.</p>
      <!-- /wp:paragraph -->
      <!-- wp:list {"fontSize":"sm"} -->
      <ul class="has-sm-font-size pp-contact-body"><li><strong>Email:</strong> <span class="pp-contact-email">hello@tourantine.com</span></li></ul>
      <!-- /wp:list -->
    </div>
    <!-- /wp:column -->
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group" style="border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
        <!-- wp:paragraph {"fontSize":"sm"} -->
        <p class="has-sm-font-size pp-contact-body">Book discovery call</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
