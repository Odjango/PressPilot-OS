...
<div class="wp-block-group alignfull presspilot-section presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline hero-title">ZooZoo Restaurant</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg","className":"hero-subtitle"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline hero-subtitle">ZooZoo restaurant has the best dinner experience in town</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons pp-hero-ctas hero-ctas" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-button pp-button-primary btn primary">
      <a class="wp-block-button__link pp-hero-cta-primary btn primary" href="#reserve">Reserve a table</a>
    </div>
    <!-- /wp:button -->
    ...
    <div class="wp-block-button pp-button-secondary is-style-outline btn secondary">
      <a class="wp-block-button__link pp-hero-cta-secondary btn secondary" href="#menu">View full menu</a>
    </div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
