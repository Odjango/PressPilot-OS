...
<div class="wp-block-group alignfull presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline">Neighborhood Fixers</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline">Neighborhood Fixers is a technician-led collective covering HVAC, electrical, and small remodeling jobs for bungalows and duplexes. Clients book through text or WhatsApp, get photo confirmations, and can tip or subscr…</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
    <!-- wp:button {"text":"Schedule a consult","url":"#contact"} /-->

    <!-- wp:button {"text":"See sample site","url":"#services","className":"is-style-outline"} /-->
  </div>
  <!-- /wp:buttons -->
</div>
<!-- /wp:group -->
