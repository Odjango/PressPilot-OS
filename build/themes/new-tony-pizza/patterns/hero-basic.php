...
<div class="wp-block-group alignfull presspilot-section presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline hero-title">New Tony Pizza</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg","className":"hero-subtitle"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline hero-subtitle">New Tony Pizza turns a century-old bakery into an open-kitchen trattoria with naturally leavened dough, local produce, and live jazz on weekends. Guests split shareable plates, browse seasonal cocktails, and order woo…</p>
  <!-- /wp:paragraph -->
