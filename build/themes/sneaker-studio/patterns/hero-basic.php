...
<div class="wp-block-group alignfull presspilot-pattern hero-basic has-soft-bg-background-color has-background">
  ...
  <h1 class="wp-block-heading has-text-align-center has-xxl-font-size pp-hero-headline">Sneaker-Studio</h1>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","fontSize":"lg"} -->
  <p class="has-text-align-center has-lg-font-size pp-hero-subheadline">Sneaker-Studio the store that has all your sneakers dreams under one roof.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons pp-hero-ctas" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-button pp-button-primary">
      <a class="wp-block-button__link pp-hero-cta-primary" href="#contact">Preview the shop</a>
    </div>
    <!-- /wp:button -->

    <!-- wp:button {"className":"pp-button-secondary is-style-outline"} -->
    <div class="wp-block-button pp-button-secondary is-style-outline">
      <a class="wp-block-button__link pp-hero-cta-secondary" href="#portfolio">Talk to sales</a>
    </div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
