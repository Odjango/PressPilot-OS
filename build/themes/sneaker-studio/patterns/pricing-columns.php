...
<div class="wp-block-group presspilot-pattern pricing-columns" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
  ...
  <h2 class="wp-block-heading has-text-align-center has-xl-font-size">Plans for every ecommerce</h2>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","textColor":"muted","fontSize":"sm"} -->
  <p class="has-text-align-center has-muted-color has-sm-font-size">Sneaker-Studio can switch tiers any time—kits stay in sync automatically.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-column">
      <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"},"border":{"width":"1px","style":"solid","color":"var:preset|color|border"},"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}},"layout":{"type":"constrained"},"className":"pp-pricing-card"} -->
      <div class="wp-block-group pp-pricing-card" style="border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
        ...
        <div class="wp-block-buttons">
          <!-- wp:button {"className":"pp-button-primary","width":100} -->
          <div class="wp-block-button pp-button-primary">
            <a class="wp-block-button__link" href="#contact">Choose Starter</a>
          </div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    ...
    <!-- wp:column -->
    <div class="wp-block-column">
      <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"},"border":{"width":"2px","style":"solid","color":"var:preset|color|primary"},"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}},"layout":{"type":"constrained"},"className":"pp-pricing-card pp-pricing-card-highlight highlight"} -->
      <div class="wp-block-group pp-pricing-card pp-pricing-card-highlight highlight" style="border-color:var(--wp--preset--color--primary);border-style:solid;border-width:2px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
        <!-- wp:heading {"level":3,"fontSize":"lg"} -->
        ...
        <div class="wp-block-buttons">
          <!-- wp:button {"className":"pp-button-primary","width":100} -->
          <div class="wp-block-button pp-button-primary">
            <a class="wp-block-button__link" href="#contact">Choose Growth</a>
          </div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group pp-pricing-card" style="border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
        ...
        <div class="wp-block-buttons">
          <!-- wp:button {"className":"pp-button-primary","width":100} -->
          <div class="wp-block-button pp-button-primary">
            <a class="wp-block-button__link" href="#contact">Choose Pro</a>
          </div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
