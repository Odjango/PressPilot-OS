/**
 * Legacy Generator Types
 *
 * These types originated from the deprecated Node.js generator (src/generator/).
 * They are preserved here because the Hero Preview feature and some Studio UI
 * components still reference them.
 *
 * TODO: Migrate hero preview to SSWG Laravel pipeline, then remove this file.
 *
 * @deprecated Use types/presspilot.ts for new code
 */
